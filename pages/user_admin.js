...
class UserAdmin extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = { atraccionesDisponibles: "", value: "", numTokens: 0, rideSelected: "", dropDownOpt: [], errorMessage: "",errorMessage2: "", message: "", precioToken: 0 , 
            ...
            <Layout>
                <div>
                    ...
                    <Form onSubmit={this.enjoyRide} error={!!this.state.errorMessage2} >
                        <Form.Field>
                            <label>Ready to enjoy the rides? Select the one you want to enjoy</label>
                            <Select
                        ...
                        <Button loading={this.state.loading2} primary>Enjoy the ride!</Button>
                    </Form>
